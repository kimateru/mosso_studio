...
import ProjA3 from '../assets/img/proj-1.2.jpg';
    ...
    return (
        <section id='hero' className='flex flex-col mt-4 text-center'>
            <div className='flex flex-col gap-5 justify-between'>
                ...
                <p className='text-sm max-w-[80%] mx-auto'>В стремительном ритме современной жизни дом- это то место, где хочется отдохнуть телом и душой. Каждый интерьер индивидуален и уникален, поэтому мы детально изучаем ваши желания и потребности, создавая пространство, идеально гармонирующее с вашим образом жизни.</p>
            </div>
            <div className='flex flex-col gap-5 justify-between mt-5'>
                <img src={Logo} alt="Mosso" className='rounded-full w-[150px] mx-auto' />
                <p className='text-sm max-w-[80%] mx-auto'>Добрый день! Меня зовут Мария,я дизайнер интерьеров ,3D визуализатор и основатель студии MOSSO.</p>
                <p className='text-sm max-w-[80%] mx-auto'>Мы специализируемся на минималистичных интерьерах, которые обеспечивают максимальный комфорт и эстетическое наслаждение.</p>
                ...
                <img src={ProjA3} alt="project img" className='h-[15%] object-cover mt-4' />
            </div>
            <div className='flex flex-col gap-5 justify-between mt-5'>
                ...
                <p className='text-sm max-w-[80%] mx-auto'>Философия нашей студии - превратить вашу мечту о идеальном доме в реальность, делая это с максимальным удобством и без лишнего стресса, чтобы после завершения этого этапа вашей жизни,у вас остались только теплые воспоминания и впечатления.</p>
            </div>
